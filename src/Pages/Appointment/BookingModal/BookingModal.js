            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 mt-6'>
                        ...
                        <input name='name' type="text" placeholder="your Name " className="input w-full input-bordered input-info" />
                        <input name='email' type="text" placeholder="Email Address" className="input w-full input-bordered input-info" />
